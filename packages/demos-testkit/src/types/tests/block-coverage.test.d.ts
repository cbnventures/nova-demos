...
export type Tests_BlockCoverage_BlockCoverage_Missing = string[];

export type Tests_BlockCoverage_BlockCoverage_CurrentBlockName = string;

export type Tests_BlockCoverage_BlockCoverage_BlockPattern = RegExp;

export type Tests_BlockCoverage_BlockCoverage_Message = string;
