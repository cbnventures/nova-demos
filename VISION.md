...
| demos-testkit     | The private, trackable `packages/demos-testkit` Nova workspace: a shared test suite that discovers every demo at runtime and asserts they remain structurally and preset-API identical.                                                                                                        |
