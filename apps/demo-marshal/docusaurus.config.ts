...
const config: DocusaurusNovaConfig = {
  ...
  title: 'Marshal',
  titleDelimiter: ' - ',
  tagline: 'Filed, sealed, automated.',
  favicon: './favicon.ico',

  // Deployment.
  url: 'https://marshal-demo.nova.cbnventures.io',
  baseUrl: '/',
  organizationName: identity['organizationName'] ?? 'cbnventures',
  projectName: 'demo-marshal',
    ...
    '@cbnventures/docusaurus-preset-nova',
    {
      ...
      plugins: {
        docs: {
          ...
          editUrl: 'https://github.com/cbnventures/nova-demos/tree/main/apps/demo-marshal/',
        ...
        blog: {
          ...
          blogTitle: 'Blog',
          blogDescription: 'Dispatches from the Department — policies filed, dockets stamped, stewardship on the record.',
          postsPerPage: 10,
          ...
          feedOptions: {
            ...
            limit: 20,
            title: 'Marshal Blog',
            description: 'Dispatches from the Department — policies filed, dockets stamped, stewardship on the record.',
          },
        },
        pages: {
          editUrl: 'https://github.com/cbnventures/nova-demos/tree/main/apps/demo-marshal/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'left',
          type: undefined,
          to: '/docs/category/dockets/',
          activeBaseRegex: '^/docs/(category/)?dockets(/|$)',
    ...
    blog: {
      ...
      layout: {
        heading: 'Blog',
        description: 'Dispatches from the Department',
      },
      share: {
        platforms: [
          'linkedin',
    ...
    // Announcement Bar.
    announcementBar: {
      id: 'marshal-archival-2',
      content: 'Set the rules once. Marshal files everything else.',
    ...
    errorPages: {
      notFound: {
        title: 'No record of this filing.',
        description: 'This URL is not on our docket. Return to the registry to begin a new entry.',
        backHomeLabel: 'Back to the registry',
        backHomeHref: undefined,
      },
      errorPageContent: {
        title: 'Filing failed on this page.',
        retryLabel: 'Refile the page',
      },
      error: {
        retryLabel: 'Retry the filing',
      },
    },
