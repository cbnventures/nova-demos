...
description: "Configuration files that nobody maintains cause drift across monorepo packages, so Foundry manifests replace per-tool configs with declarations."
authors:
  - "elena"
keywords:
  - "nova demos"
