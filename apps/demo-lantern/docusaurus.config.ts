...
const config: DocusaurusNovaConfig = {
  ...
  title: 'Lantern',
  titleDelimiter: ' - ',
  tagline: 'Watchful, warm, always home.',
  favicon: './favicon.ico',

  // Deployment.
  url: 'https://lantern-demo.nova.cbnventures.io',
  baseUrl: '/',
  organizationName: identity['organizationName'] ?? 'cbnventures',
  projectName: 'demo-lantern',
    ...
    '@cbnventures/docusaurus-preset-nova',
    {
      ...
      plugins: {
        docs: {
          ...
          editUrl: 'https://github.com/cbnventures/nova-demos/tree/main/apps/demo-lantern/',
        ...
        blog: {
          ...
          blogTitle: 'Blog',
          blogDescription: 'From the porch light — updates, patterns, and quiet notes from the house.',
          postsPerPage: 10,
          ...
          feedOptions: {
            ...
            limit: 20,
            title: 'Lantern Blog',
            description: 'From the porch light — updates, patterns, and quiet notes from the house.',
          },
        },
        pages: {
          editUrl: 'https://github.com/cbnventures/nova-demos/tree/main/apps/demo-lantern/',
  ...
  themeConfig: {
    ...
    blog: {
      ...
      layout: {
        heading: 'Blog',
        description: 'From the porch light',
      },
      share: {
        platforms: [
          'linkedin',
    ...
    announcementBar: {
      id: 'lantern-ledger-2',
      content: 'Was the alarm on at 2am? Lantern keeps the answer.',
    ...
    errorPages: {
      notFound: {
        title: 'This entry is not in the journal.',
        description: 'It may have been lost between the pages, or never written at all.',
        backHomeLabel: 'Back to the table of contents',
        backHomeHref: undefined,
      },
      errorPageContent: {
        title: 'This entry could not be opened.',
        retryLabel: 'Reopen the entry',
      },
      error: {
        retryLabel: 'Retry the entry',
      },
    },
