...
| (preset bundle) `packages/docusaurus-preset-nova/translations/locales/zh-Hans/theme-nova.json` | Nova chrome (`theme.SearchBar.*`, `theme.navbar.moreLabel`, `theme.footer.creditNovaLabel`, etc.) | Preset          |
| (upstream) `@docusaurus/theme-translations/locales/zh-Hans/theme-common.json`                  | Docusaurus built-in chrome                                                                        | Docusaurus      |
