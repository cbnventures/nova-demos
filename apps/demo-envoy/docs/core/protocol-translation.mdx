...
sidebar_position: 1
description: "Parcel rewrites incoming messages into the destination format with field mapping and lossy versus lossless transforms, requiring no shared schema."
tags:
  - "core"
  - "protocol"
---
